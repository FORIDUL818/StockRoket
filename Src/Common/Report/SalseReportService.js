...
const salseProductModel = require("../../Models/Salse/SalseProductModel");

const SalseReportService = async (req) => {
  try {
    let userEmail = req.headers.email;
    let fromDate = req.body.fromDate;
    let toDate = req.body.toDate;

    let data = await salseProductModel.aggregate([
      {
        $match: {
          userEmail:userEmail,
          createDate: {
...
module.exports = SalseReportService;
